...
-- Create the entity for a hyper accumulator
local hyperAccumulator = util.table.deepcopy(data.raw["accumulator"]["accumulator"])
hyperAccumulator.name = "hyper accumulator"
hyperAccumulator.icons = {
    {
        icon = hyperAccumulator.icon,
        tint = {r=0.4,g=0.4,b=0.6,a=0.6}
    },
}

hyperAccumulator.minable.results = {
    {
        type = "item",
...
hyperAccumulator.flags = {"placeable-neutral", "player-creation"}

hyperAccumulator.max_health = 1500
hyperAccumulator.corpse = "accumulator-remnants"
hyperAccumulator.collision_box = {{-0.9, -0.9}, {0.9, 0.9}}
hyperAccumulator.selection_box = {{-1, -1}, {1, 1}}
hyperAccumulator.drawing_box = {{-1, -1.5}, {1, 1}}

hyperAccumulator.energy_source =
{
    type = "electric",
    buffer_capacity = "1EJ",
    usage_priority = "tertiary",
...
hyperAccumulator.charge_cooldown = 30
hyperAccumulator.discharge_cooldown  = 60

hyperAccumulator.charge_light = {intensity = 0.3, size = 7, color = {r=0.4,g=0.4,b=0.6,a=0.6}}
hyperAccumulator.picture = accumulator_picture()
hyperAccumulator.circuit_wire_connection_point = circuit_connector_definitions["accumulator"].points
hyperAccumulator.circuit_connector_sprites = circuit_connector_definitions["accumulator"].sprites
hyperAccumulator.circuit_wire_max_distance = default_circuit_wire_max_distance
...
recursive_tint(hyperAccumulator, {r=0.4,g=0.4,b=0.6,a=0.6})


data:extend{hyperAccumulator}